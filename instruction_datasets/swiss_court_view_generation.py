...
class SwissCourtViewGeneration(AbstractDataset):
    ...
    def get_data(self, instructions: instruction_manager.InstructionManager):
        ...
        for example in df:
            instruction, instruction_language = instructions.sample("swiss_judgment_court_view_generation_same_court")
        ...
        for example in df:
            instruction, instruction_language = instructions.sample("swiss_judgment_court_view_generation_lower_court")
