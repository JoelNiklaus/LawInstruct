...
class Littleton(AbstractDataset):
    ...
    def get_data(self):
        json_files = [pos_json for pos_json in os.listdir(f"{self.raw_data_dir}/littleton/examples/") if pos_json.endswith('.json')]
        instruction_bank = [
        ...
        for json_file in json_files:
            with open(os.path.join(f"{self.raw_data_dir}/littleton/examples/", json_file), "r") as f:
        ...
        json_files = [pos_json for pos_json in os.listdir(f"{self.raw_data_dir}/littleton/tests/edwards") if
        ...
        for json_file in json_files:
            with open(os.path.join(f"{self.raw_data_dir}/littleton/tests/edwards/", json_file), "r") as f:
