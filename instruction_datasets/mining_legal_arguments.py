...
class MiningLegalArguments(AbstractDataset):
    def __init__(self):
        super().__init__("MiningLegalArguments", "https://github.com/trusthlt/mining-legal-arguments")
    ...
    def get_data(self):
        ...
        for type in ["agent", "argType"]:
            ...
            df = load_dataset(f"joelito/mining_legal_arguments_{type}", split="train")
            ...
            for example in df:
                ...
                yield self.build_data_point(prompt_language, "en", text, task_type, jurisdiction, subset=type)
